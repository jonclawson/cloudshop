...
export const mockStripe = {
    ...
    confirmPayment: async (paymentIntentId, cardToken) => {
...
export const mockPrintful = {
    ...
    createOrder: async (items, designFileUrl) => {
...
export const mockMailchannels = {
    ...
    sendOrderConfirmation: async (email, orderId, items) => {
        const html = `
...
export async function getStripeService(useMocks) {
    return useMocks ? mockStripe : null; // Real Stripe would go here
}
export async function getPrintfulService(useMocks) {
    return useMocks ? mockPrintful : null; // Real Printful would go here
}
export async function getMailchannelsService(useMocks) {
